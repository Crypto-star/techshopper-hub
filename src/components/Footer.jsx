    ...
    <footer className="bg-gray-800 text-white py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4 text-blue-400">TechnoMart</h3>
            <p className="text-sm text-gray-300">Your one-stop shop for electronic components, STEM toys, and engineering projects.</p>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/resources" className="text-gray-300 hover:text-blue-400 transition-colors">Resources</Link></li>
            </ul>
          </div>
          <div>
            <h4 className="text-lg font-semibold mb-4 text-blue-400">Contact Us</h4>
            <p className="text-sm text-gray-300">123 Tech Street, Silicon Valley, CA 94000</p>
            <p className="text-sm text-gray-300">Email: info@technomart.com</p>
